...
function App() {
    ...
    const [person, setPerson] = useState<IData>({id:0, age:0, name:"", firstname:""});
    // console.log(persons);
    ...
    const editiere = (p:IData) => {
        console.log(p);
        setPerson(p);
    }

    const onSave = (p:IData, id:number)=>{
    ...
    return (
        <>
            ...
            <section className="center2">
                <PersonenListe editiere={editiere} data={persons} />
                <PersonView onSave={onSave} p={person}/>
            </section>
            <section className="center2">
